                         ...
                         kparms*      kp)
{
    ...
    res += hal_pin_float_new("scarakins-m.D1", HAL_IO, &(haldata->d1), comp_id);
    res += hal_pin_float_new("scarakins-m.D2", HAL_IO, &(haldata->d2), comp_id);
    res += hal_pin_float_new("scarakins-m.D3", HAL_IO, &(haldata->d3), comp_id);
    res += hal_pin_float_new("scarakins-m.D4", HAL_IO, &(haldata->d4), comp_id);
    res += hal_pin_float_new("scarakins-m.D5", HAL_IO, &(haldata->d5), comp_id);
    res += hal_pin_float_new("scarakins-m.D6", HAL_IO, &(haldata->d6), comp_id);
    if (res) { goto error; }
...
{
    kp->kinsname    = "scarakins-m"; // !!! must agree with filename
    kp->halprefix   = "scarakins-m"; // hal pin names
